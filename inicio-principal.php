...
<html lang="en">
	<head>
		...
		<title>Toy's Land - Bienvenido</title>
				...
				<div class="row datos-cent">
					...
					<div class="col-md-7">
						...
						<div name="botones" class="esp-arr margenabj1em">
                            <a href="Registro-juguetes.php"><button type="button" class="btn blue-btn form-group esp-arr">Inicio</button></a>

                            <button type="button" class="btn red-btn form-group esp-arr esp-arr-3"  onclick="javascript: cerrar_sesion();">Cerrar Admin</button>
                        </div>

						<div class="esp-arr-3 margenabj1em">
							<a href="MANUAL DE USUARIO.pdf" download="Manual de usuario.pdf"><button type="button" class="btn green-btn form-group esp-arr esp-arr-3">Manual de usuario</button></a>
						</div>
					</div>
